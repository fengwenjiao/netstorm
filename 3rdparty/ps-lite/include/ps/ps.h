...
/** \brief Returns the number of groups, add by cqq */
    inline int NumGroups() { return Postoffice::Get()->num_groups(); }
...
/** \brief Returns the group id of this node, add by cqq */
//inline int MyGroup() {return Postoffice::Get()->my_group(); }
/**
